...
<body>
    <div class="w-full max-w-md px-6 py-8 sm:px-10 sm:py-12">
        <div class="login-container p-8 sm:p-10">
            ...
            <!-- Login Form -->
            <form id="loginForm" class="space-y-6" method="POST" action="" novalidate>
                ...
                <div class="input-group">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            autofocus
                            class="block w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300 outline-none text-gray-900 placeholder-gray-400"
                ...
                <div class="input-group">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="block w-full pl-12 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300 outline-none text-gray-900 placeholder-gray-400"
                ...
                <button 
                    type="submit" 
                    id="submitBtn"
                    class="btn-login w-full flex items-center justify-center px-6 py-3.5 bg-gradient-to-r from-primary to-blue-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-primary focus:ring-opacity-50">
